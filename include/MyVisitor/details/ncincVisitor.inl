...
Ret Visitor<Ret (Impl::*)(void*, Args...)>::Visit(std::size_t ID, void* ptr,
                                                  Args... args) {
...
void Visitor<Ret (Impl::*)(void*, Args...)>::RegisterOne() {
  impl_callbacks[details::CustomID<Derived>::get()] = [](Impl* impl, void* ptr,
                                                         Args... args) {
    return details::Accessor<Impl>::template run<Derived*, Ret>(
        impl, ptr, std::forward<Args>(args)...);
  };
}

template <typename Impl, typename Ret, typename... Args>
bool Visitor<Ret (Impl::*)(void*, Args...)>::IsRegistered(
    std::size_t ID) const {
