...
#include <MyVisitor/cicVisitor.h>
#include <MyVisitor/cincVisitor.h>
#include <MyVisitor/ncVisitor.h>
#include <MyVisitor/ncicVisitor.h>
#include <MyVisitor/ncincVisitor.h>
...
int main() {
  ...
  {  // const
    ...
    auto visit_tri = [](const Triangle*) {
      cout << "Lambda(const Triangle*)" << endl;
    };
    auto visit_sphere = [](const Sphere*) {
      cout << "Lambda(const Sphere*)" << endl;
    };
    visitor.Register(visit_tri, visit_sphere);
    Triangle tri;
    Sphere sphere;
  ...
  {  // non-const impl non-const visitor
    class V : public Visitor<void (V::*)(void*)> {
     ...
     protected:
      void ImplVisit(Triangle*) { cout << "V::ImplVisit(Triangle*)" << endl; }
    };
